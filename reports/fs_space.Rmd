...
rat_linecloud <- linecloud +
  geom_emoji(data = mutate(portal_sad, sim = 1, qbin = .1, qbin_alpha = 1), aes(x = rank, y = sabund), emoji = "1f42d")

rat_linecloud

rat_coeff_linecloud <- fs_coeffs_linecloud +
  geom_emoji(data = mutate(portal_leg_coeffs, sim = 1, qbin = .1, qbin_alpha = 1),
